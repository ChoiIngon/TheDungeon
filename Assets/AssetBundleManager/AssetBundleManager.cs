...
{	
	...
	public class AssetBundleManager : MonoBehaviour
	{
		...
		static public AssetBundleLoadManifestOperation Initialize (string manifestAssetBundleName)
		{
			...
			m_DownloadBundles.Clear();
			#if UNITY_EDITOR
			Log (LogType.Info, "Simulation Mode: " + (SimulateAssetBundleInEditor ? "Enabled" : "Disabled"));
#endif

            AssetBundleManager instance = (AssetBundleManager)GameObject.FindObjectOfType<AssetBundleManager>();
            if(null == instance)
            {
		...
		static public void LoadAssetBundle(string assetBundleName, bool isLoadingAssetBundleManifest = false)
		{
			...
			if (false == isLoadingAssetBundleManifest && false == m_DownloadBundles.ContainsKey(assetBundleName))

			{

				m_DownloadBundles.Add(assetBundleName, assetBundleName);
